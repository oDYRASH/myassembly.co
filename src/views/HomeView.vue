<script setup>
  ...
  onMounted(() => {
    ...
    //         hoverElement.innerText = 'You are hovering!';
    //     });

    //     hoverElement.addEventListener('mouseout', function() {
    //         hoverElement.style.backgroundColor = 'lightblue';
    //         hoverElement.innerText = 'Hover over me!';
    //     });
    // });
  });
...
<template>
  ...
  <Model3D :scrollPosition="scrollPosition" :modelName="'0258'" :assemblyContainerId="'homePageCanvas'" :controls="false"/>
  <!-- START SECTIONS -->
  <section id="section1">
