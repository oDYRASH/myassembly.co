...
function initThreeJs(containerId = null, autoSpin = false, controls = true, callback = null, modelName) {
...
//     const base = { x: 0, y: 4, z: 14 };
//     const sceneContainer = document.getElementById(containerId);
//     console.log(sceneContainer, containerId);
//     TG = new Group();
...
//Three.js init
export function build3Dmodel(containerId = null, autoSpin = false, controls = true, callback = null, modelName) {
